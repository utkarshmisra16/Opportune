...
const JobCard = (props:any) => {
    return (
        <Link to="/jobs" className="bg-mine-shaft-900 p-4 m-3 w-72 flex flex-col gap-3 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400 justify-evenly">
