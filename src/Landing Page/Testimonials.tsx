...
const Testimonials = () => {
    return <div className="mt-20 pb-5">
        ...
        <div className="flex justify-evenly">
            {
                testimonials.map((data, index) => <div key={index} className="flex flex-col gap-3 w-[23%] border-bright-sun-400 p-3 mx-3 border rounded-xl mt-10">
                    <div className="flex gap-2 items-center">
                        <Avatar className="!h-14 !w-14" src="/images/avatar.png" alt="it's me" />
                        <div>
